...
class Gridder(object):
    ...
    def addShowHideControl(self, cat, ctrl):
        ...
        for ctrl in list(self._showHideControlDict.values()):
    ...
    **kargs):
    ...
    def showHideWdg(self, **kargs):
        ...
        for cat, doShow in list(kargs.items()):
        ...
        for wdg, catList in list(self._showHideWdgDict.items()):
            for cat in catList:
    ...
    def _showHideWdgCallback(self, wdg=None):
        ...
        """
        for cat, wdg in list(self._showHideControlDict.items()):
